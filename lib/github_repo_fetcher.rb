...
class GitHubRepoFetcher
  ...
  def docs(repo_name:, path_in_repo:, path_prefix:, service_name:, branch: "master", ignore_files: [])
...

      {
        ...
        proxy_args: {
          locals: {
            service_name:,
            title:,
            external_doc_contents: ExternalDoc.parse(contents, repo_name:, branch:, path: file.path),
          },
          data: {
